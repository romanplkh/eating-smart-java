...
//    private Vitamin vitamins = new Vitamin();
//
//
//
//
...
//    }
//
////    private Map<String, VitaminDetails> getVitamins(Map<String, LinkedHashMap<String, Object>> vitaminsDaily) {
////
////
...
////
////        //FILTERED VITAMINS
//////        Map<String, VitaminDetails> filtered = myCOllVitamins.entrySet().stream().filter(obj -> filteredWords.indexOf(obj.getKey()) == -1).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (e1, e2) -> e1,
//////                LinkedHashMap::new));
////
////
////        //Set collection to Class Models.Vitamin
